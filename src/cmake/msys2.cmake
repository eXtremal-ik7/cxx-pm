...
# libgnutls
set(LIBGNUTLS_URL https://mirror.msys2.org/msys/x86_64/libgnutls-3.8.8-1-x86_64.pkg.tar.zst)
set(LIBGNUTLS_SHA256 b885c627935bbc46f99c27d52d21f48334e5be72d79b5f2d1e3a9d65dda5d1a3)
# libnettle
set(LIBNETTLE_URL https://mirror.msys2.org/msys/x86_64/libnettle-3.10-1-x86_64.pkg.tar.zst)
set(LIBNETTLE_SHA256 9059ea22e447ac4e79e96b2b5c2ece7fe4a076ff6a235c0137605dd86fe4f09e)
# libhogweed
set(LIBHOGWEED_URL https://mirror.msys2.org/msys/x86_64/libhogweed-3.10-1-x86_64.pkg.tar.zst)
set(LIBHOGWEED_SHA256 9d5d5b95d4e07f2cb41ab854c416ece9198a5fb6d8c275708b454f670c15e91e)
# wget
...
function (msys2_build)
  ...
  download_file(msys2_libgnutls ${LIBGNUTLS_URL} ${LIBGNUTLS_SHA256})
  download_file(msys2_libnettle ${LIBNETTLE_URL} ${LIBNETTLE_SHA256})
  download_file(msys2_libhogweed ${LIBHOGWEED_URL} ${LIBHOGWEED_SHA256})
  ...
  install_file(${msys2_libgnutls_PATH})
  install_file(${msys2_libnettle_PATH})
  install_file(${msys2_libhogweed_PATH})
  ...
  install(CODE "
    ...
    file(RENAME ${CMAKE_INSTALL_PREFIX}/usr/bin/msys-crypt-0.dll ${CMAKE_INSTALL_PREFIX}/usr/bin/msys-crypt-2.dll)
  ")
endfunction()
